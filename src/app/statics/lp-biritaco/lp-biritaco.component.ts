...
@Component({
  selector: 'app-lp-biritaco',
  templateUrl: './lp-biritaco.component.html',
  styleUrls: ['./lp-biritaco.component.scss'],
})
export class LpBiritacoComponent implements OnInit, OnDestroy {
  data: Date = new Date();
